...
class AnimalControllerTest {
    ...
    @Test
    public void should_Call_Get_All_Animal_Dto_Of_Animal_Service() {
        // given
    ...
    @Test
    public void pageRequest_Should_Be_First_Page_Of_20_Animals_Dto_Sorted_By_Asc_Label() throws Exception {
        // given
        when(animalService.getAllAnimalDto(defaultPageRequest)).thenReturn(slice);
        ...
        // then
        verify(animalService).getAllAnimalDto(captor.capture());
        PageRequest usedPageRequest = captor.getValue();
        assertThat(usedPageRequest).isEqualTo(defaultPageRequest);
    }

    @Test
    public void pageRequest_Should_Be_Second_Page_Of_Animals_Dto() throws Exception {
        // given
    ...
    @Test
    public void pageRequest_Should_Be_Page_Of_5_Animals_Dto() throws Exception {
        // given
    ...
    @Test
    public void pageRequest_Should_Be_Page_Of_Animals_Dto_Sorted_By_Desc_Label() throws Exception {
        // given
